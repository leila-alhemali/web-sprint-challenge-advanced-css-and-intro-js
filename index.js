...
let newArtist = getArtistByIndex(artists, 2);
...
2. Add this object of information to the end of the array
  { 
    ...
    genre: Web Designer, Ceramicist
    nationality: Arab-American
    bio:  Leila uses web design to push the one of the oldest artistic disciplines -- Ceramics. Blending clay and coding is the latest pursuit to use technology to enhance all facets of human life. From 3-D printing clay to modeling complex patterns and automating the firing process, Leila's ceramics harken back to times long forgotten and make the viewer wonder about what our future holds. 
  }  
3. Return the resulting array

Example: addArtist(artists) should return the artists array with the above object added to the end of the array. */
function createArtist(id, name, years, genre, nationality, bio) {
  return {
    id,
    name,
    years,
...
let artist = createArtist(
  ...
  "Leila Ayad",
  "1995 - current day",
  "Web Designer, Ceramicist",
  "Arab-American",
  "Leila uses web design to push the one of the oldest artistic disciplines -- Ceramics. Blending clay and coding is the latest pursuit to use technology to enhance all facets of human life. From 3-D printing clay to modeling complex patterns and automating the firing process, her ceramics harken back to times long forgotten and make the viewer wonder about what our future holds."
);
...
let arrayOfPainters = lotsOfArt(artists);
console.log(arrayOfPainters);
